...
export const P2pSsvProxyFactoryAbi = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: 'P2pSsvProxyFactory__CannotRemoveZeroSelectors',
    type: 'error',
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: 'P2pSsvProxyFactory__DepositDataArraysShouldHaveTheSameLength',
    type: 'error',
  },
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint64', name: '_ssvOperatorId2', type: 'uint64' },
    ],
    name: 'P2pSsvProxyFactory__DuplicateOperatorOwnersNotAllowed',
    type: 'error',
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_actualEthValue', type: 'uint256' },
    ],
  ...
  {
    inputs: [],
    name: 'P2pSsvProxyFactory__MaxSsvTokenAmountPerValidatorNotSet',
    type: 'error',
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: 'P2pSsvProxyFactory__NotEnoughEtherPaidToCoverSsvFees',
    type: 'error',
  },
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: 'uint64', name: '_operatorId', type: 'uint64' },
      { internalType: 'address', name: '_passedOwner', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'p2pSsvProxyInstance', type: 'address' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'p2pSsvProxy', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint64[8]', name: '', type: 'uint64[8]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      {
        internalType: 'address[]',
        name: '_allowedSsvOperatorOwnersToRemove',
        type: 'address[]',
      },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint64[8]', name: '_operatorIds', type: 'uint64[8]' },
      { internalType: 'address', name: '_ssvOperatorOwner', type: 'address' },
    ],
...
export const P2pSsvProxyFactoryAddresss = process.env
